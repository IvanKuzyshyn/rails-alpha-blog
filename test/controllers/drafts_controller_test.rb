...
class DraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create draft" do
    assert_difference('Draft.count') do
      post drafts_url, params: { draft: { body: @draft.body, copy: @draft.copy, recepient: @draft.recepient, title: @draft.title } }
    end
  ...
  test "should update draft" do
    patch draft_url(@draft), params: { draft: { body: @draft.body, copy: @draft.copy, recepient: @draft.recepient, title: @draft.title } }
